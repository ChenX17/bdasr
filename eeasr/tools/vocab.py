...
def make_word_count_douyin10000h():
    text_path_in = '/mnt/cephfs_hl/speech/training/asr/lingvo/input/douyin_10000h_wav/labels_R200.txt'
    word_path_out = './words_s2s.txt'
    make_word(text_path_in, word_path_out)
